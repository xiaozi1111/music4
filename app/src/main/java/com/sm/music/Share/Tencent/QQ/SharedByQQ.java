...
public class SharedByQQ implements Connect{
    ...
    public void SharedByQQ_PicMess() {
        ...
        //分享的标题
        params.putString(QQShare.SHARE_TO_QQ_TITLE, "微音乐·让音乐更懂你");
        //分享的内容
        ...
        //软件的标题
        params.putString(QQShare.SHARE_TO_QQ_APP_NAME, "微音乐");
    ...
    public void sharedByQQ_Music(Music current_music){
        ...
        params.putString(QQShare.SHARE_TO_QQ_TITLE, "微音乐·聆听你我");
        //你把当前播放的音乐的信息传进来
    ...
    public void shareToQZone() {
        final Bundle params = new Bundle();
        params.putString(QQShare.SHARE_TO_QQ_TITLE, "微音乐·传递快乐");
        params.putString(QQShare.SHARE_TO_QQ_SUMMARY, "微音乐，让音乐回归本质，让音乐传递更多快乐~");
